...
modo = "Marcación"
with st.sidebar:
    # --- CABECERA: USANDO TU NUEVO ARCHIVO Lobo.png ---
    c1, c2 = st.columns([1, 4])
    with c1:
        if os.path.exists("Lobo.png"):
            st.image("Lobo.png", width=50)
    with c2:
        st.markdown("<h1 style='color: #1E3A8A; font-size: 24px; margin-top: 5px;'>Gestión Lobo</h1>", unsafe_allow_html=True)
...
else: # --- ADMIN COMPLETO: FILTROS Y TOTALES ---
